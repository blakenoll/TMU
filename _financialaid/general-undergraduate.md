...
- amount: Up to $1,500
  award-text: |-
    ...
    * Awarded to students who receive sponsorship from a Christian ministry. TMU will match, on a dollar-for-dollar basis, up to a total of $1,500 per student, as long as funds remain available. Renewed scholarships that were eligible for the Ministry Matching Grant will be matched up to the same amount as the previous year but not to exceed $2,500.

    * Matching funds only guaranteed with eligible applications received before August 1st

    * Click [here](file:///undergrad/financial-aid/generalundergraduateprogram/ministrymatchinggrant.aspx "ministrymatchinggrant") for more information on this grant.
