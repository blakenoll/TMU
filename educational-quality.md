...
<p style="padding-left: 30px;"><span class="italicText"><span style="text-decoration: underline;"><a class="tab" href="#test2" title="AIMS Summaries" target="_self">TMU Student Academic Performance Summaries</a></span></span>: <br />This option provides a link to a set of summary reports taken from our Assessment Information Management System (AIMS).  The reports summarize TMCS student assessment data organized around the Program-Level Learning Outcomes (PLOs) for each major and degree program.</p>
